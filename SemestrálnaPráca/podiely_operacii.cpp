...
namespace test {
    ...
    //test pre ADT zoznam
    void test_adt_list(int* arr, structures::List<int>& newList) {
        for (int i = 0; i < 100; i++)
        ...
        for (int i = 0; i < MIL; i++)
        {
            ...
            case(1):
                ...
                case(1):
                    ...
                    newList.insertFirst(gen_number(5));
                    break;
                case(2):
                    //operacia_vloz_posledny(gen_number(range));
                    newList.add(gen_number(5));
                    break;
                case(3):
                    //operacia_vloz_na_index(gen_number(range), gen_number(range))
                    newList.insert(gen_number(5), gen_number(5));
                    break;
                }
                break;
            case(2):
            ...
            case(3):
                ...
                case(1):
                    ...
                    newList[gen_number(5)];
                    break;
                case(2):
                    //operacia_nastav(gen_number(range), gen_number(range));
                    newList.set(gen_number(5), gen_number(5));
                    break;
                }
                break;
            case(4):
                //operacia_index_prvku
                newList.getIndexOf(gen_number(5));
                break;
            }
        }
    }
