...
namespace structures
{
	...
	protected:
		...
		int startIndex_; //Aby som vedel kde mi zacina v poli prislusny front

		/// <summary> Pocet prvkov vo fronte. </summary>	
		size_t size_; //Budem potrebovat velkost, aby som vedel kolko prvok vo fronte mam
	};

	template<typename T>
	ImplicitQueue<T>::ImplicitQueue() :
		ImplicitQueue(10)
		//Principialne by sa hodil aj ArrayList
		//Ak budem pridavat prvky na zaciatok, znamenalo by to
		//Ze pri kazdej oper. vkladania by som musel vsetky prvky
		//V ArrayListe posuvat o index
		//Ak by som pridaval na koniec, tak nic nemusim posuvat
		//Ale skomplikoval by som si odoberanie na zaciatku
		//Kedy by som musel vsetky prvky ArrayListu posuvat do lava
		//V ARRAYLISTE SA POSUVANIU PRVKOV NEVYHNEME!

		//Preto pouzijeme ARRAY!
		//Pole ma ale obmedzenu Kapacitu
		//Implicitny front bude mat obmedzenu kapacitu
		//Ale na druhej strane budeme mat jedn. oper. efektivnejsie
	{
	}
