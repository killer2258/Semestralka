...
namespace structures
{
	...
	protected:
		...
		//Vkladanie aj vyberanie pomocou tohto atributu...
	...
	template<typename T>
	inline PriorityQueueList<T>::~PriorityQueueList() // musim vymazat aj priority queue item
	{
		this->clear(); //Zavolame operaciu clear nad frontom
		delete this->list_;
		this->list_ = nullptr;
